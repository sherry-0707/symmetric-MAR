...
def main():
    ...
    parser.add_argument('--dgp_core',type=float,default=0.7,help='g=[core]*r')
    ...
    for rep in tqdm(range(args.n_rep)):
        ...
        y,true_A,true_G,true_U1,true_U2,true_U3,f_A = DGP_MAR(args.N,args.T,burn=500,P=args.dgp_p,g=torch.tensor([args.dgp_core]*args.dgp_r),seed=rep+args.seed)
        ...
        if rep % 10 == 9:
            logging.info('Midway result for replication {}-{}: mean est err^2 {}'.format(args.seed,rep+args.seed,torch.mean(est_err[:rep])))
